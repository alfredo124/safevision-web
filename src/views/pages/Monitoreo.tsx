...
import { Plus, Trash2, AlertTriangle, Maximize2, X } from 'lucide-react';
...
// Función para obtener estilos dinámicos del panel según el color de la infracción
...
// Cálculo dinámico de estadísticas por tipo de gravedad
...
const totalLeves = activeInfracciones.filter((i) => i.color === '#eab308').length;
  ...
  return (
    ...
    <div className="space-y-6">
      {/* Sección de Estadísticas con Desglose */}
      ...
      {/* Lista Dinámica de Infracciones Detectadas */}
      <div className="space-y-3">
      ...
      <div className="flex-1 p-3 grid grid-cols-2 auto-rows-fr gap-3 bg-[#0d0e12] w-full h-full overflow-y-auto">
        ...
        <button
          ...
          className="border-2 border-dashed border-gray-800 hover:border-emerald-500/50 bg-[#12141a]/50 hover:bg-[#161922] rounded flex flex-col items-center justify-center gap-2 text-gray-500 hover:text-emerald-400 transition-all group min-h-[220px]"
        >
